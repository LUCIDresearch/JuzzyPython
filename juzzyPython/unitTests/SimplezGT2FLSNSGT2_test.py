"""
SimplezGT2FLSNSGT2_test.py
Created 9/3/2022
"""
import sys
import numpy as np
import unittest
from juzzyPython.examples.SimplezGT2FLSNSGT2 import SimplezGT2FLSNSGT2
import logging
...
class TestSimpleT2FLS(unittest.TestCase):
    ...
    def testCentroidDefuzz(self):
        ...
        f = "../javaTestResults/SimplezGT2FLSNSGT2Centroid.txt"
        test = SimplezGT2FLSNSGT2(unit=True)
    ...
    def testHeightDefuzz(self):
        log= logging.getLogger("Test")
        f = "../javaTestResults/SimplezGT2FLSNSGT2Height.txt"
        test = SimplezGT2FLSNSGT2(unit=True)
