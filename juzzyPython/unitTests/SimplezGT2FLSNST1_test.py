"""
SimplezGT2FLSNST1_test.py
Created 9/3/2022
"""
import sys
import numpy as np
import unittest
from juzzyPython.examples.SimplezGT2FLSNST1 import SimplezGT2FLSNST1
import logging
...
class TestSimpleT2FLS(unittest.TestCase):
    ...
    def testCentroidDefuzz(self):
        ...
        f = "../javaTestResults/SimplezGT2FLSNST1Centroid.txt"
        test = SimplezGT2FLSNST1(unit=True)
    ...
    def testHeightDefuzz(self):
        log= logging.getLogger("Test")
        f = "../javaTestResults/SimplezGT2FLSNST1Height.txt"
        test = SimplezGT2FLSNST1(unit=True)
