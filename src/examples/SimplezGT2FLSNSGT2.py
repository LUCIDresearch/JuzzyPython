...
class SimplezGT2FLSNSGT2:
    ...
    It is the same example as SimpleGT2FLS with a non singleton input GT2.
    ...
    def __init__(self,unit = False) -> None:
        ...
        inputMfprimer = IntervalT2MF_Gaussian("inputmfprimer",inputumf,inputlmf)
        inputMf = GenT2MF_Gaussian("inputmf",inputMfprimer,self.numberOfzLevels)
        #Inputs to the FLS
